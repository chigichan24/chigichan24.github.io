...
const translations: Translations = {
  en: {
    ...
    "about.presentation.crune2026.speakerdeck": "https://zenn.dev/chigichan24/articles/eed4a60d102997",
    ...
    "about.presentation.duff2026.speakerdeck": "https://dev.to/chigichan24/i-built-a-browser-only-git-diff-viewer-using-file-system-access-api-no-server-needed-282g",
